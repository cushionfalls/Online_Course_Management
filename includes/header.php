...
<body class="min-h-screen flex flex-col bg-base-100 text-base-content font-sans">
    <div class="navbar bg-base-100 shadow-sm border-b border-base-200">
        <div class="flex-1">
            <a href="index.php" class="btn btn-ghost text-xl font-bold tracking-tight">Learning</a>
        </div>
        <div class="flex-none">
            <ul class="menu menu-horizontal px-1">
                <?php if(isset($_SESSION['role'])): ?>
                    <li class="badge badge-outline mr-2"><?php echo htmlspecialchars(ucfirst($_SESSION['role'])); ?></div></li>
